...
#define kFlickrAPIKey @"43a67e77150ddfdae0939a89e5dcab2f"
#define kFlickrAPISecret @"577727bcdbcdc384"
...
+ (NSString *)flickrSearchURLForSearchTerm:(NSString *) searchTerm
{
    ...
    return [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=%@&text=%@&per_page=5&format=json&nojsoncallback=1",kFlickrAPIKey,searchTerm];
}
